...
<head>
    <meta charset="UTF-8">
    <title>Verify Your Email – INVOIZ Rider Application</title>
</head>
...
<div style="max-width: 560px; margin: 0 auto; background: #FFFFFF; border: 1px solid #E8E6E0; border-radius: 12px; padding: 32px;">
    ...
    <p>Use the verification code below to verify the email address for your INVOIZ Rider application:</p>
